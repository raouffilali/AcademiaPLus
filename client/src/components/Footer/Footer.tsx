...
function Footer() {
  return (
    // <!-- Footer container -->
    <footer className="bg-neutral-50 text-center text-neutral-800  text-sm lg:text-left">
