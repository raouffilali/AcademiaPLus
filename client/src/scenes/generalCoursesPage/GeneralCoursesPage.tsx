...
import FeaturedSection from "../../components/ForGeneralCourses Components/FeaturedSection";
...
function GeneralCoursesPage() {
  ...
  return (
    <>
      <UrgentNews />
      <NavBar />
      <div className=" mt-10 lg:ml-[80px] lg:mr-[80px] md:mx-auto sm:mx-auto ">
        <div className="flex ">
          {/* aside section */}
          ...
          <div className="w-4/5 p-6">
            ...
            <HzCard />
            <br />
            <FeaturedSection buttonText="Graphic Design"/>
          </div>
        </div>
      </div>
      <Footer />
