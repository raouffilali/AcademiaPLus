...
const sidebarOptions: SidebarOption[] = [
  ...
  { label: "My Subscription", value: "mysubscriptions", icon: <HiOutlineDeviceMobile /> },
  { label: "Billing Info", value: "billinginfo", icon: <HiOutlineCurrencyDollar /> },
  { label: "Payment", value: "payment", icon: <HiOutlineStar /> },
  { label: "Invoice", value: "invoice", icon: <HiOutlineChartPie /> },
            ...
            if (option.value === "editprofile") {
              return (
                <React.Fragment key={option.value}>
                  <p className="text-gray-400 font-mono text-xs pt-6 ">ACCOUNT SETTINGS</p>
                  <li
