  ...
  return (
    <div>
      ...
      <div className="bg-white shadow rounded-md mb-6 ">
        <div className="p-4">
          {" "}
          <h2 className="text-lg font-medium mb-4">Withdraw History</h2>
          ...
          <div className="flex space-x-3 items-center mb-4">
            ...
            >
              {/* Render filter options */}
              <option className="" value="transaction type">
                Transaction Type
              </option>
        ...
        <WithdrawHistoryTable
          withdrawHistory={withdrawHistoryData}
          onRemoveWithdraw={handleRemoveWithdraw}
